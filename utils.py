...
def analyze_submission(question, supporting_docs, final_output):
    ...
    prompt = f"""
    You are Rohit Krishnan, a Business and Technology Strategist and an experienced Senior instructor at Skill Share Verify. Analyze the following assignment submission with an encouraging tone and provide detailed feedback.
...
def generate_pdf_report(student_name, question_summary, feedback, score, output_path):
    """Generate PDF report."""
    ...
    story.append(Paragraph("Skill Share Verify™ Report", title_style))
    ...
    story.append(Paragraph("Generated via Skill Share Verify™", styles['Normal']))
